...
export default function Creator() {
  ...
  const contract = useNFTCollection(
    '0xcC0b15f09c939B57382387E181d8A70A34269a56',
  );
  ...
  const generateSignature = useCallback(async () => {
    ...
    const payload = await contract?.signature.generate({
      ...
      to: '0xB1F47275B57e3288545a21846D45F754A78CeF21', // Who will receive the NFT (or AddressZero for anyone)
      price: 0.5, // the price to pay for minting
      currencyAddress: NATIVE_TOKEN_ADDRESS, // the currency to pay with
      mintStartTime: startTime, // can mint anytime from now
      mintEndTime: endTime, // to 24h from now,
      royaltyRecipient: '0xB1F47275B57e3288545a21846D45F754A78CeF21', // custom royalty recipient for this NFT
      royaltyBps: 100, // custom royalty fees for this NFT (in bps)
      primarySaleRecipient: '0xB1F47275B57e3288545a21846D45F754A78CeF21', // custom sale recipient for this NFT
    });
    setPayload(payload);
  }, [module, metadata]);
